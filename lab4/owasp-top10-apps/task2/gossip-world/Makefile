...
compose: compose-down
	docker-compose -f deployments/docker-compose.yml -p labs up -d --build --force-recreate

## Down project using docker-compose
compose-down:
	docker-compose -f deployments/docker-compose.yml -p labs down -v --remove-orphans
